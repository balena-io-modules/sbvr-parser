...
* Simplify getting the identifiers in `getValidFactTypeParts` [Pagan Gazzard]
* Avoid unnecessary `.call` usage [Pagan Gazzard]
* Simplify `matchForAny` [Pagan Gazzard]
* Avoid `.includes` when unnecessary [Pagan Gazzard]
* Reduce array slices in `traverseRecurse` [Pagan Gazzard]
* Avoid unnecessary cloning [Pagan Gazzard]
